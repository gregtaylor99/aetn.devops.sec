...
verify = True
token = ''
username = 'devops@aenetworks.com'
password = 'Aetn@105mph!'
...
if __name__ == '__main__':
    ...
    scan_data = add('Test Scan', 'Create a new scan with API', '172.16.41.233, 172.16.23.183', policy_id)
    scan_id = scan_data['id']

    print('Updating scan with new targets.')
    update(scan_id, scan_data['name'], scan_data['description'], '172.16.41.141, 172.16.0.22, 172.16.27.237, 172.16.15.240, 172.16.6.109, 172.16.16.52, 172.16.1.96')
